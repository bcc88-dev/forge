...
# Find the end of print_docker_status function
# It ends with: console.print(f'[{CYAN}]╰─────────────────────────────────────────────────────╯[{CYAN}]\\n')
pattern = r\"console\\.print\\(f'\\\\[CYAN\\\\\\]╰─────────────────────────────────────────────────────╯\\\\[CYAN\\\\\\]\\\\n'\\)\"
...
'''
    ...
    print(f'Functions added successfully at position {insert_pos}')
else:
